const apiKey = '76198daa22b03a9f70365cc6242f4cd0'; // Reemplaza con tu clave API
...
searchButton.addEventListener('click', async () => {
    ...
    if (query) {
        try {
            ...
            const data = await response.json();
            displayMovies(data.results); // Llama a la función para mostrar los resultados de búsqueda
        } catch (error) {
